...
export function UpgradePrompt({ feature, tier, onClose }: UpgradePromptProps) {
  return (
    <motion.div
      ...
      exit={{ opacity: 0, y: 10 }}
      className="bg-gradient-to-r from-primary-50 to-secondary-100 dark:from-primary-900/50 dark:to-surface-dark/50 border border-primary-300 dark:border-primary-700/50 rounded-2xl p-4"
    >
      <div className="flex items-start space-x-3">
        <div className="flex-shrink-0 w-8 h-8 bg-accent-500 rounded-xl flex items-center justify-center">
