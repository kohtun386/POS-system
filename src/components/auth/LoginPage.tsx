    ...
    <div className="min-h-screen bg-secondary-50 dark:bg-primary-950 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md animate-fade-in relative z-10">
        <div className="text-center mb-6">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-primary-600 to-primary-700 rounded-2xl mb-4 shadow-copper">
            <ShoppingCart className="h-8 w-8 text-white" />
          </div>
          <h1 className="text-2xl font-bold text-secondary-900 dark:text-secondary-100 mb-2">CoffeeShop POS</h1>
        ...
        <div className="card p-8 border-0">
          ...
          <div className="mt-4 p-4 bg-gradient-to-r from-secondary-100 to-primary-50 dark:from-surface-dark dark:to-primary-900 rounded-xl border border-secondary-200 dark:border-secondary-800">
            <p className="text-xs font-bold text-secondary-900 dark:text-secondary-100 mb-2 text-center">Need any help?</p>
            <p className="text-xs text-secondary-600 dark:text-secondary-300 text-center">
