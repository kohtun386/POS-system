-- ================================================================
-- Fix checkout_complete: include shop_id in sales INSERT
-- After removing hardcoded DEFAULT values from sales.shop_id, the
-- column is NOT NULL with no default. checkout_complete must set it
-- explicitly from its existing p_shop_id parameter.
-- ================================================================
