-- ================================================================
-- Migration: Enhanced Atomic Deduction Trigger
-- Date: June 25, 2026
-- Description:
--   Replaces deduct_raw_materials() to ALSO deduct products.stock
--   atomically. This eliminates the need for the app-level stock
--   update loop in CheckoutModal.tsx.
-- ================================================================
...
-- Drop and recreate to ensure the new function is used
